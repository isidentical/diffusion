...
def build_autoencoder(input_channels: int = 3,
    ...
    Args:
        ...
        use_fourier_feature_transform (bool): Whether to use a Fourier Feature Transform. Default: `False`.
    """
    ...
    autoencoder = AutoEncoder(
        ...
        use_fourier_feature_transform=use_fourier_feature_transform,
    )
